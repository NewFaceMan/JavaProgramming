...
public class HappyFace2 extends JFrame {
	...
	public void paint(Graphics g) {
		...
		g.drawArc(170, 250, 150, 100, 0, 180); 
		/* (x,y) : (170, 250), wide 100, high 180의 직사각형을
		 * 만든 후 그 안에 접하는 타원을 만든다. 그 후 0도에서 180도까지 원의 호를 사용한다.
		 */
	}
